# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2018-03-06 08:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teach_years', models.IntegerField(default=0, verbose_name='\u6559\u5b66\u5e74\u9650')),
                ('teach_subject', models.CharField(max_length=50, verbose_name='\u79d1\u76ee')),
                ('points', models.CharField(max_length=50, verbose_name='\u6559\u5b66\u7279\u70b9')),
                ('click_nums', models.IntegerField(default=0, verbose_name='\u70b9\u51fb\u6570')),
                ('fav_nums', models.IntegerField(default=0, verbose_name='\u6536\u85cf\u6570')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now)),
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organization.School', verbose_name='\u6240\u5c5e\u5b66\u6821')),
            ],
            options={
                'verbose_name': '\u6388\u8bfe\u6559\u5e08',
